...
@fromserver_emsp_211.route("/credentials/POST_cpo_Credentials", methods=['POST'])
@requires_auth
def fromserver_post_cpo_credentials():
    ...
    # GET the URL
    if ParameterService.get_parameters_by_key_userid(Parameter.ENDPOINT_211_CPO_CREDENTIALS, session_user_id):
        test_request.url = ParameterService.get_parameters_by_key_userid(Parameter.ENDPOINT_211_CPO_CREDENTIALS,
        ...
        test_request.url = user_endpoint + Constants.TO_CPO_CREDENTIALS_211_ENDPOINT_CONSTANT
    ...
    iop_ws = IOPWebserviceService.get_iop_webservice_by_ocpiversion_name_type(ocpiversion=OCPIVersion.two_one_one,
                                                                              name=IOPWebservice.WS_NAME_POST_cpo_credentials,
...
@fromserver_emsp_211.route("/credentials<wildcard:path>", methods=['PATCH', 'PUT', 'DELETE', 'GET', 'POST'])
@requires_auth
def fromserver_emsp_credentials_error_no_ws(path):
