...
@ocpi_cpo_211.route("/credentials", methods=['POST'])
@requires_auth_api
def toserver_post_cpo_credentials():
    # Init result table
    result_tab = []
...
@ocpi_cpo_211.route("/credentials<wildcard:path>", methods=['GET', 'PUT', 'POST', 'PATCH', 'DELETE'])
@requires_auth_api
def toserver_cpo_credentials_error_no_ws(path):
