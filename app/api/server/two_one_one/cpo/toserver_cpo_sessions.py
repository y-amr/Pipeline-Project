...
@ocpi_cpo_211.route("/sessions", methods=['GET'])
@requires_auth_api
def toserver_get_cpo_sessions():
    # Init result table
    result_tab = []
...
@ocpi_cpo_211.route("/sessions<wildcard:path>", methods=['GET', 'PUT', 'POST', 'PATCH', 'DELETE'])
@requires_auth_api
def toserver_cpo_sessions_error_no_ws(path):
